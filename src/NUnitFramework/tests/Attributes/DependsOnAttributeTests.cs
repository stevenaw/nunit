...
namespace NUnit.Framework.Tests.Attributes
{
    ...
    public class DependsOnAttributeTests
    {
        ...
        [Test]
        public void DependencyFixturesAreNotForcedNonParallel()
        {
        ...
        [Test]
        public void ParallelIndependentFixtureCanRunBeforeDependentFixture()
        {
            ...
            var beforeTearDownIndex = FixtureDependencyEvents.Events.IndexOf(nameof(FixtureDependencyParallelBeforeSlow) + ".OneTimeTearDown");
            var afterSetUpIndex = FixtureDependencyEvents.Events.IndexOf(nameof(FixtureDependencyParallelAfter) + ".OneTimeSetUp");
            var independentSetUpIndex = FixtureDependencyEvents.Events.IndexOf(nameof(FixtureDependencyParallelIndependent) + ".OneTimeSetUp");
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(beforeTearDownIndex, Is.GreaterThanOrEqualTo(0));
                Assert.That(afterSetUpIndex, Is.GreaterThan(beforeTearDownIndex));
                Assert.That(independentSetUpIndex, Is.GreaterThanOrEqualTo(0));
                Assert.That(independentSetUpIndex, Is.LessThan(afterSetUpIndex));
            });
        }
    }
}
